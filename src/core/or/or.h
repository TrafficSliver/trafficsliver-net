...
#define RELAY_COMMAND_SPLIT_SET_COOKIE 48
#define RELAY_COMMAND_SPLIT_COOKIE_SET 49
#define RELAY_COMMAND_SPLIT_JOIN 50
#define RELAY_COMMAND_SPLIT_JOINED 51
#define RELAY_COMMAND_SPLIT_INSTRUCTION 52
#define RELAY_COMMAND_SPLIT_INFO 53
#define RELAY_COMMAND_SPLIT_EVAL 54
